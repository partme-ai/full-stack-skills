...
| 文档 | 说明 |
| :--- | :--- |
| `{V}/1、{Name}-需求调研文档-{V}.md` | 需求调研 |
| `{V}/2、{Name}-需求分析文档-{V}.md` | 需求分析 |
| `{V}/3、{Name}-系统架构设计-{V}.md` | 版本架构 |
| `{V}/4、{Name}-功能与界面规划-{V}.md` | 功能与界面规划 |
| `{V}/6、{Name}-功能菜单与版本规划-{V}.md` | 本版功能菜单 |
| `{V}/7、{Name}-UI设计说明-{V}.md` | UI 设计说明 |
| `other/10、技术细分模板.md` 或 `其他/` | 接口/表结构细节 |
...
| 文档类型 | 文档名称 | 版本 | 说明 |
| :--- | :--- | :--- | :--- |
| 技术文档 | `other/10、技术细分模板.md` 或研发仓库 | V1.0.0 | 技术实现方案 |
...
- `{V}/2、{Name}-需求分析文档-{V}.md`
- `9、{Name}-视觉与交互DNA规范.md`
- `{V}/7、{Name}-UI设计说明-{V}.md`
- `other/10、技术细分模板.md`
