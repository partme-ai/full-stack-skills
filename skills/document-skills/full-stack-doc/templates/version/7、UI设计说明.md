...
| 文档 | 说明 |
| :--- | :--- |
| `9、`9、{Name}-视觉与交互DNA规范.md`` | 全局 DNA |
| `{V}/5、{Name}-PRD文档-{V}.md` | PRD |
| `{V}/2、{Name}-需求分析文档-{V}.md` | 需求分析 |
| 模块目录 `*-UI设计说明-{V}.md` | 模块细稿 |
...
| 文档类型 | 文档名称 | 版本 | 说明 |
| :--- | :--- | :--- | :--- |
| 需求分析文档 | `{V}/2、{Name}-需求分析文档-{V}.md` | V1.0.0 | 功能需求和用户故事 |
| UI设计稿 | {Name}-UI设计稿 | V1.0 | Figma/Sketch设计文件 |
| 原型图 | {Name}-原型图 | V1.0 | 交互原型文件 |
| DNA规范 | `9、{Name}-视觉与交互DNA规范.md` | V1.0.0 | 设计DNA规范 |
...
**详细规范请参考**：`9、`9、{Name}-视觉与交互DNA规范.md``
