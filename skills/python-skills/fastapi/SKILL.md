...
1. **核心**：FastAPI()、@app.get/post、Path/Query/Body；Pydantic 模型与校验。
2. **进阶**：Depends、OAuth2、后台任务、WebSocket；OpenAPI 文档。
3. **参考**：https://fastapi.tiangolo.com/
...
fastapi, 异步 API, Pydantic, OpenAPI
